...
class TransaksiController extends Controller
{
    ...
    {
        $transaksis = TransaksiModel::select('id_penjualan', 'user_id', 'pembeli', 'penjualan_tanggal')
            ->with('user');
        ...
        return DataTables::of($transaksis)
            ...
            ->addColumn('aksi', function ($transaksi) {
                $btn = '<a href="'.url('/transaksi/' . $transaksi->id_penjualan).'" class="btn btn-info btn-sm">Detail</a> ';
                $btn .= '<form class="d-inline-block" method="POST" action="'. url('/transaksi/'.$transaksi->id_penjualan).'">'.
